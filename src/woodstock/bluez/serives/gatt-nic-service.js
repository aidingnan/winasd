...
class GattNICService extends DBusObject {
  ...
  constructor (name, primary) {
    ...
    this.addInterface(new GattService({
      UUID: '10000000-0182-406c-9221-0a6680bd0943',
      Primary: !!primary
    }))

    this.txIface1 = new WriteNotifyChar({
      UUID: '10000002-0182-406c-9221-0a6680bd0943',
      indicate: true
    })
    ...
    this.txIface2 = new WriteNotifyChar({
      UUID: '10000003-0182-406c-9221-0a6680bd0943',
      indicate: true
    })
